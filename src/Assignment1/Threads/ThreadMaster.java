...
import Assignment1.Threads.Observers.CountersObeserver;
import Assignment1.Threads.Observers.RankingListObserver;
...
public class ThreadMaster extends Thread{
    final int nSlavesThread = Runtime.getRuntime().availableProcessors() / 2;
